...
admin_district_shp_path = "/home/joyanta/Documents/HDSS_Documents/Weather Data Interpolation/GeoInterpolBD/data/bgd_adm_bbs_shp/bgd_adm_bbs_20201113_SHP/bgd_admbnda_adm2_bbs_20201113.shp"
...
print(bd_weather_stations.shape)
...
# create map
bd_plot_locations.plot(column='ADM0_EN', cmap=map_color, linewidth=0.8, ax=ax, edgecolor='.9')
